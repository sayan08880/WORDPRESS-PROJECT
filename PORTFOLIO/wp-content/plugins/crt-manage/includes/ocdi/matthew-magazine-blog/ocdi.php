...
function crt_manage_import_files() {
    return [
        [
            'import_file_name'             => 'Matthew Magazine Blog',
            'categories'                   => [ 'Blog' ],
            'import_file_url'            => 'http://demo1.crthemes.com/data/matthew/content.xml',
            'import_widget_file_url'     => 'http://demo1.crthemes.com/data/matthew/widgets.wie',
            'import_customizer_file_url' => 'http://demo1.crthemes.com/data/matthew/customizer.dat',
