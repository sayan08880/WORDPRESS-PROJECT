...
function crt_manage_import_files() {
    return [
        [
            'import_file_name'             => 'Pascal News Magazine',
            'categories'                   => [ 'Magazine' ],
            'import_file_url'            => 'http://demo1.crthemes.com/data/pascal/content.xml',
            'import_widget_file_url'     => 'http://demo1.crthemes.com/data/pascal/widgets.wie',
            'import_customizer_file_url' => 'http://demo1.crthemes.com/data/pascal/customizer.dat',
...
function crt_manage_after_import_setup() {
    ...
    crt_manage_update_data('https://demo1.crthemes.com/pascal/');
}
