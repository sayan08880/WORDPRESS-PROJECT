...
function crt_manage_import_files() {
    return [
        [
            'import_file_name'             => 'Egan Portfolio Resume',
            'categories'                   => [ 'Ecommerce' ],
            'import_file_url'            => 'http://demo1.crthemes.com/data/egan/content.xml',
            'import_widget_file_url'     => 'http://demo1.crthemes.com/data/egan/widgets.wie',
            'import_customizer_file_url' => 'http://demo1.crthemes.com/data/egan/customizer.dat',
