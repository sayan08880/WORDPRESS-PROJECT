...
function crt_manage_import_files() {
    return [
        [
            'import_file_name'             => 'Arana Creative Portfolio',
            'categories'                   => [ 'Creative' ],
            'import_file_url'            => 'http://demo1.crthemes.com/data/arana/content.xml',
            'import_widget_file_url'     => 'http://demo1.crthemes.com/data/arana/widgets.wie',
            'import_customizer_file_url' => 'http://demo1.crthemes.com/data/arana/customizer.dat',
