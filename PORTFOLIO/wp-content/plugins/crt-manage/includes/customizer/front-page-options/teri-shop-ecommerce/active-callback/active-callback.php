...
function crt_manage_is_section_product_2($control) {
    return $control->manager->get_setting( 'crt_manage_enable_product_2_section' )->value();
}
...
function crt_manage_is_carousel_text_section_enabled($control) {
    return $control->manager->get_setting( 'crt_manage_enable_carousel_text_section' )->value();
}
?>