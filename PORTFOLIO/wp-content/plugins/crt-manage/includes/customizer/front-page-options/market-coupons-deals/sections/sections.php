...
if ( ! function_exists( 'crt_manage_category_one_section' ) ) {
    function crt_manage_category_one_section() {
        $template = get_template_directory() . '/sections/product-cat-one.php';
        if(file_exists($template)) {
            require $template;
        }
    }
...
if ( ! function_exists( 'crt_manage_category_two_section' ) ) {
    function crt_manage_category_two_section() {
        $template = get_template_directory() . '/sections/product-cat-two.php';
        if(file_exists($template)) {
            require $template;
        }
    }
...
if ( ! function_exists( 'crt_manage_product_tab_section' ) ) {
    function crt_manage_product_tab_section() {
        $template = get_template_directory() . '/sections/product-tab.php';
        if(file_exists($template)) {
            require $template;
        }
    }
...
function priority_section_theme( $section_order_default = array()) {
    ...
    $section_order_default = array (
        ...
        'crt_manage_category_one_section' => $i += 5,
        'crt_manage_product_section' => $i += 5,
        'crt_manage_category_two_section' => $i += 5,
