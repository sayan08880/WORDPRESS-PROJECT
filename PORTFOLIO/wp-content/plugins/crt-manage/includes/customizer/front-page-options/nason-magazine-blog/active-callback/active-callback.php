...
function crt_manage_is_hero_v1_is_not_content($control) {
    return !$control->manager->get_setting( 'crt_manage_enable_hero_v1_is_content' )->value();
}

function crt_manage_is_hero_v1_is_content($control) {
    return $control->manager->get_setting( 'crt_manage_enable_hero_v1_is_content' )->value();
}
