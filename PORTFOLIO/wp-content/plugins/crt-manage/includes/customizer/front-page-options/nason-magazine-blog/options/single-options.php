...
$options['crt_manage_single_option'] = array(
    ...
    'control' => array(
        ...
        'crt_manage_single_is_share' => array(
            'label'    => esc_html__( 'Enable Share', 'crt-manage' ),
            'def' => true,
            'type' => 'toggle_switch',
            'class' => 'Crt_Manage_Toggle_Switch_Custom_Control',
        ),
        'crt_manage_single_is_read_time' => array(
            'label'    => esc_html__( 'Enable Read Time', 'crt-manage' ),
            'def' => true,
            'type' => 'toggle_switch',
            'class' => 'Crt_Manage_Toggle_Switch_Custom_Control',
        ),
