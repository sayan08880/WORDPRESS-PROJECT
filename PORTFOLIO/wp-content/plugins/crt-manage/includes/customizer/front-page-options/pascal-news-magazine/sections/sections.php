...
if ( ! function_exists( 'crt_manage_post_select_section' ) ) {
    function crt_manage_post_select_section() {
        $template = get_template_directory() . '/sections/post-select.php';
        if(file_exists($template)) {
            require $template;
        }
    }
...
if ( ! function_exists( 'crt_manage_author_section' ) ) {
    function crt_manage_author_section() {
        $template = get_template_directory() . '/sections/author.php';
        if(file_exists($template)) {
            require $template;
        }
    }
