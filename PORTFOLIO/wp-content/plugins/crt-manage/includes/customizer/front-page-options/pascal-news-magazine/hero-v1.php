...
$options['crt_manage_hero_v1_section'] = array(
    ...
    'control' => array(
        ...
        'crt_manage_hero_v1_left_post' => array(
            'label'           => esc_html__( 'Left Post', 'crt-manage' ),
            'def' => '',
            'type' => 'select_multiple',
            'class' => 'Crt_Manage_Customize_Select_Multiple',
            'choices' => crt_manage_get_post_choices(),
            'active_callback' => 'crt_manage_is_layout_hero_v2_3',
        ),
        'crt_manage_hero_v1_center_post' => array(
            ...
            'class' => 'Crt_Manage_Customize_Select_Multiple',
            'choices' => crt_manage_get_post_choices(),
            'active_callback' => 'crt_manage_is_layout_hero_v1_2',
        ),
        'crt_manage_hero_v1_right_post' => array(
            'label'           => esc_html__( 'Right Post', 'crt-manage' ),
            'def' => '',
            'type' => 'select_multiple',
            'class' => 'Crt_Manage_Customize_Select_Multiple',
            'choices' => crt_manage_get_post_choices(),
        ...
        'crt_manage_hero_v1_slider_on_row' => array(
            ...
            'active_callback' => 'crt_manage_is_layout_hero_v1',
        ),
