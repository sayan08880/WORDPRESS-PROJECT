...
$prefix_header_option = 'crt_manage_header_show_';
...
$options['crt_manage_header_options'] = array(
    ...
    'control' => array(
        'crt_manage_my_tabs' => array(
            ...
            'tabs'    => array(
                'font_family' => array(
                    ...
                    'icon'     => 'desktop',
                    'controls' => array(
                        $prefix_header_option.'left_nav',
                        $prefix_header_option.'social',
                        $prefix_header_option.'cart',
                        $prefix_header_option.'search',
                ...
                'font_sizes'   => array(
                    ...
                    'controls' => array(
                        $prefix_header_option.'social_m',
                        $prefix_header_option.'cart_m',
                        $prefix_header_option.'search_m',
                    ),
                ),
            ),
        ),
        $prefix_header_option . 'left_nav' => array(
            'label'    => esc_html__( 'Left Nav', 'crt-manage' ),
            'def' => true,
            'type' => 'toggle_switch',
            'class' => 'Crt_Manage_Toggle_Switch_Custom_Control',
            'selective_refresh' => true,
        ),
        $prefix_header_option.'nav_button' => array(
            'label'           => esc_html__( 'Button Nav', 'crt-manage' ),
            'type' => 'checkbox',
        ),
        $prefix_header_option.'social' => array(
            'label'           => esc_html__( 'Social', 'crt-manage' ),
            'type' => 'checkbox',
        ),
        $prefix_header_option.'cart' => array(
            'label'           => esc_html__( 'Icon Cart (Woo)', 'crt-manage' ),
            'type' => 'checkbox',
            'def' => true,
        ),
        $prefix_header_option.'search' => array(
            'label'           => esc_html__( 'Icon Search', 'crt-manage' ),
            'type' => 'checkbox',
            'def' => true,
        ),
        ...
        // Options for mobile
        $prefix_header_option.'social_m' => array(
            'label'           => esc_html__( 'Social', 'crt-manage' ),
            'type' => 'checkbox',
        ),
        $prefix_header_option.'cart_m' => array(
            'label'           => esc_html__( 'Icon Cart (Woo)', 'crt-manage' ),
            'type' => 'checkbox',
            'def' => false,
        ),
        $prefix_header_option.'search_m' => array(
            'label'           => esc_html__( 'Icon Search', 'crt-manage' ),
            'type' => 'checkbox',
            'def' => false,
        ),
