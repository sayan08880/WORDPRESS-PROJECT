...
$options['crt_manage_footer_options'] = array(
    ...
    'control' => array(
        'crt_manage_footer_instagram_feed_enable' => array(
            'label'    => esc_html__( 'Enable Instagram', 'crt-manage' ),
            'def' => true,
            'type' => 'toggle_switch',
            'class' => 'Crt_Manage_Toggle_Switch_Custom_Control',
        ),
        'crt_manage_footer_instagram_feed' => array(
            'label'    => esc_html__( 'Instagram Feed', 'crt-manage' ),
            'type' => 'text',
            'description' => 'Shortcode Instagram Feed'
        ),
        'crt_manage_footer_instagram_feed_enable_fullwidth' => array(
