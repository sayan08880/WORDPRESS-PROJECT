...
if ( ! function_exists( 'crt_manage_mushava_magazine_fonts' ) ) :
    /**
     * Return Google fonts URL.
     */
    function crt_manage_mushava_magazine_fonts() {
        $fonts_url = '';
        $fonts     = array();
...
//       --background-active: "#222";
    ...
    wp_register_style( 'mushava-magazine-blog-style-inline', false );
    wp_enqueue_style( 'mushava-magazine-blog-style-inline' );
    wp_add_inline_style( 'mushava-magazine-blog-style-inline', $custom_css );
    wp_enqueue_style( 'mushava-magazine-blog-google-fonts', wptt_get_webfont_url( crt_manage_mushava_magazine_fonts() ), array(), null );
}
