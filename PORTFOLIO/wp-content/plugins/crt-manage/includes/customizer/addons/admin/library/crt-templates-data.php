...
class CRT_Templates_Data {
	public static function get_available_kits() {
		$is_pro_active = true;
		$is_expert = $is_pro_active;
		...
		return [
			...
			'digital-seo-marketing-agency' => [
				...
				'v2' => [
					...
					'price' => $is_pro_active ? 'free' : 'pro',
					'expert' => $is_expert ? 'free' : 'expert',
					'custom-types' => ['crt-work' => 'crt_work', 'crt-work-category' => 'crt_work_cats'],
					'label' => 'new',
					'priority' => 3,
				],
			],
			...
			'realestate' => [
				...
				'v3' => [
					...
					'price' => $is_pro_active ? 'free' : 'pro',
					'expert' => $is_expert ? 'free' : 'expert',
					'custom-types' => ['crt-directory' => 'crt_directory', 'crt-property-feat' => 'crt_property_feat', 'crt-property-type' => 'crt_property_type'],
					'label' => 'New',
					'priority' => 270,
				],
			],
			...
			'job-listing' => [
				'v1' => [
					...
					'price' => $is_pro_active ? 'free' : 'pro',
					'expert' => $is_expert ? 'free' : 'expert',
					'custom-types' => ['crt-job-listing' => 'crt_job_listing', 'crt-job-industries' => 'crt_job_industry'],
					'label' => 'new',
					'priority' => 105,
				],
			],
