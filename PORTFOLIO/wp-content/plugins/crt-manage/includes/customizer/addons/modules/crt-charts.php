...
class CRT_Charts extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Charts', 'crt-manage' );
	}

	public function get_icon() {
		return 'crt-icon eicon-align-end-v';
	}
	...
	public function get_keywords() {
		return [  'line charts', 'radar charts', 'doughnut charts', 'pie charts', 'polararea charts', 'polar charts', 'bar charts', 'horizontal charts', 'vertical charts' ];
	}
	...
	public function get_script_depends() {
		return [ 'crt-charts', 'crt-charts-js' ];
	}
	...
	public function add_control_choose_chart_data_source() {
        $this->add_control(
            'data_source',
            [
                'label'              => __( 'Data Source', 'crt-manage' ),
                'type'               => Controls_Manager::SELECT,
                'default'            => 'custom',
                'options'            => [
                    'custom' => __( 'Custom', 'crt-manage' ),
                    'csv'    => 'CSV' . __( ' File', 'crt-manage' ),
                ],
    ...
    protected function register_controls() {
		...
		$this->add_control(
			'csv_source',
			[
				'label'              => __( 'CSV Source', 'crt-manage' ),
				'type'               => Controls_Manager::SELECT,
				'default'            => 'url',
				'options'            => [
					'url' => __( 'Remote URL', 'crt-manage' ),
					'file' => __( ' File', 'crt-manage' ),
				],
				'condition'   => [
					'data_source' => 'csv',
				],
		...
		$this->add_control(
			'data_source_csv_url',
			[
				'label'       => __( 'Remote URL', 'crt-manage' ),
				'type'        => Controls_Manager::TEXT,
				'dynamic' => [
					'active' => true,
				],
		...
		$this->add_control(
			...
			[
				'label'       => __( 'Upload CSV File', 'crt-manage' ),
		...
		$this->add_control(
			'chart_type',
			[
				'label'   => esc_html__('Chart Styles', 'crt-manage'),
				'type'    => Controls_Manager::SELECT,
				'description' => esc_html__('doughnut, pie and polarArea charts only work with custom data source', 'crt-manage'),
				'default' => 'bar',
				'options' => [
					'bar'           => esc_html__('Bar Vertical', 'crt-manage'),
					'bar_horizontal' => esc_html__('Bar Horizontal', 'crt-manage'),
					'line'          => esc_html__('Line', 'crt-manage'),
					'radar'         => esc_html__('Radar', 'crt-manage'),
					'doughnut'      => esc_html__('Doughnut', 'crt-manage'),
					'pie'           => esc_html__('Pie', 'crt-manage'),
					'polarArea'     => esc_html__('Polar Area', 'crt-manage'),
				],
				'separator' => 'before'
			]
		);
		...
		$this->add_control(
			'data_type',
			[
				'label'              => __( 'Data Grid Type', 'crt-manage' ),
				'type'               => Controls_Manager::SELECT,
				'options'            => [
					'linear'      => __( 'Linear', 'crt-manage' ),
					'logarithmic' => __( 'Logarithmic', 'crt-manage' ),
				],
				'default'            => 'linear',
				'condition' => [
		...
		$this->add_control(
			...
			[
				'label' => esc_html__('Exclude Data on Legend Click', 'crt-manage'),
		...
		$this->add_control(
			'stacked_bar_chart',
			[
				'label' => esc_html__('Enable Stacked Chart', 'crt-manage'),
				'type' => Controls_Manager::SWITCHER ,
				'default' => 'yes',
				'return_value' => 'yes',
				'condition' => [
		...
		$this->add_control(
			'inner_datalabels',
			[
				'label' => esc_html__('Show Data Values', 'crt-manage'),
				'type' => Controls_Manager::SWITCHER ,
				'default' => 'false',
				'return_value' => 'true',
				'condition' => [
		...
		$this->add_control(
			'enable_min_max',
			[
				'label' => esc_html__( 'Min-Max Values', 'crt-manage' ),
				'type' => Controls_Manager::SWITCHER,
				'default' => 'no',
				'return_value' => 'yes',
				'separator' => 'before',
		...
		$this->add_control(
			'min_value', 
			[
				'label'       => esc_html__('Min. Value', 'crt-manage'),
				'type'        => Controls_Manager::NUMBER,
				'default'     => -100,
				'condition' => [
					'enable_min_max' => 'yes',
		...
		$this->start_controls_section(
            'section_chart_data',
			[
				'label' => esc_html__( 'Data', 'crt-manage' ),
				'tab' => Controls_Manager::TAB_CONTENT,
			]
        );
		...
		$this->add_control( //TODO: use this instead of repeater
			'charts_labels_data', [
				'label'       => esc_html__('Data Labels', 'crt-manage'),
				'type'        => Controls_Manager::TEXTAREA,
				'dynamic' => [
					'active' => true,
				],
				'default'     => esc_html__('January, February, March', 'crt-manage'),
				'description' => esc_html__('Enter the comma-separated list of values (Used only with custom data source)', 'crt-manage'),
				'label_block' => true,
				'condition'   => [
					'data_source' => 'custom',
		...
		$chart_repeater_labels->add_control(
			'chart_data_label', [
				...
				'default'     => esc_html__('Label #1', 'crt-manage'),
				'label_block' => true,
			]
		);
		...
		$chart_repeater_labels->add_control(
			'chart_data_set', [
				...
				'default'     => '10,23,15',
				'label_block' => true,
				'description' => esc_html__("Only works with custom charts. Enter comma separated data values (Shouldn't Exceed number of values provided in Data Labels option).", 'crt-manage'),
			]
		);
		...
		$this->add_control(
			'charts_data_set',
			[
				'label'   => esc_html__('Set Data', 'crt-manage'),
				'type'    => Controls_Manager::REPEATER,
				'default' => [
					[
						'chart_data_label'            => esc_html__('Laptops', 'crt-manage'),
					...
					[
						'chart_data_label'            => esc_html__('Phones', 'crt-manage'),
					...
					[
						'chart_data_label'            => esc_html__('Other', 'crt-manage'),
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Axis', 'crt-manage' ),
				'tab' => Controls_Manager::TAB_CONTENT,
				'condition'   => [
		...
		$this->add_control(
			'display_r_axis',
			[
				'label' => esc_html__('Grid Lines', 'crt-manage'),
				'type' => Controls_Manager::SWITCHER ,
				'default' => 'true',
				'return_value' => 'true'
			]
		...
		$this->add_control(
			'grid_line_width_r', [
				'label'       => esc_html__('Grid Line Width', 'crt-manage'),
				'type'        => Controls_Manager::NUMBER,
				'default'     => '1',
				'step' => 0.1,
				'condition' => [
		...
		$this->add_control(
			'display_r_ticks',
			[
				'label' => esc_html__('Ticks (Labels)', 'crt-manage'),
				'type' => Controls_Manager::SWITCHER ,
				'default' => 'true',
				'return_value' => 'true'
			]
		...
		$this->add_control(
			'border_dash_length_r', [
				'label'       => esc_html__('Border Dash length', 'crt-manage'),
				'type'        => Controls_Manager::NUMBER,
				'default'     => '1',
				'separator' => 'before',
			]
		...
		$this->add_control(
			'border_dash_spacing_r', [
				'label'       => esc_html__('Border Dash spacing', 'crt-manage'),
				'type'        => Controls_Manager::NUMBER,
				'default'     => '1'
			]
		);
		...
		$this->add_control(
			'border_dash_offset_r', [
				'label'       => esc_html__('Border Dash offset', 'crt-manage'),
				'type'        => Controls_Manager::NUMBER,
				'default'     => '1'
			]
		);
		...
		$this->add_control(
			'x_axis_conditions',
			[
				'label' => esc_html__( 'X-Axis', 'crt-manage' ),
				'type' => Controls_Manager::HEADING,
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'placeholder' => esc_html__( 'X-Axis', 'crt-manage' ),
				'default' => esc_html__('X-Axis', 'crt-manage'),
				'condition' => [
		...
		$this->add_control(
			...
			[
				'label'              => __( 'Ticks (Labels) Rotation', 'crt-manage' ),
				'type'               => Controls_Manager::NUMBER,
				'min'                => 0,
				'max'                => 360,
				'default'            => 0,
		...
		$this->add_control(
			'y_axis_conditions',
			[
				'label' => esc_html__( 'Y-Axis', 'crt-manage' ),
				'type' => Controls_Manager::HEADING,
				'separator' => 'before'
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'placeholder' => esc_html__( 'Y-Axis', 'crt-manage' ),
				'default' => esc_html__('Y-Axis', 'crt-manage'),
				'condition' => [
		...
		$this->add_control(
			'reverse_x',
			[
				'label' => esc_html__( 'Reverse Charts', 'crt-manage' ),
				'type' => Controls_Manager::SWITCHER,
				'default' => 'no',
				'return_value' => 'yes',
				'separator' => 'before',
		...
		$this->add_control(
			...
			[
				...
				'placeholder' => esc_html__( 'To Be Applied', 'crt-manage' ),
				'default' => esc_html__('To Be Applied', 'crt-manage'),
				'condition' => [
		...
		$this->add_control(
			...
			[
				...
				'options' => [
					...
					// 'chartArea' => esc_html__( 'chartArea', 'crt-manage' ),
				],
				'condition' => [
					'show_chart_title' => 'yes',
				]
		...
		$this->add_control(
			...
			[
				...
				'label_block' => false,
				'options' => [
					'start' => esc_html__( 'Start', 'crt-manage' ),
					'center' => esc_html__( 'Center', 'crt-manage' ),
					'end' => esc_html__( 'End', 'crt-manage' ),
				],
				'condition' => [
					'show_chart_title' => 'yes',
				]
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Legends', 'crt-manage' ),
				'tab' => Controls_Manager::TAB_CONTENT,
			]
		);
		...
		$this->add_control(
			'show_chart_legend',
			[
				'label' => esc_html__( 'Show Legends', 'crt-manage' ),
				'type' => Controls_Manager::SWITCHER,
				'default' => 'yes',
				'return_value' => 'yes',
			]
		...
		$this->add_control(
			'reverse_legend',
			[
				'label' => esc_html__( 'Reverse', 'crt-manage' ),
				'type' => Controls_Manager::SWITCHER,
				'default' => 'no',
				'return_value' => 'yes',
				'condition' => [
		...
		$this->add_control(
			'charts_legend_shape',
			[
				'label' => esc_html__( 'Shape', 'crt-manage' ),
				'type' => Controls_Manager::SELECT,
				'default' => 'rectangle',
				'label_block' => false,
				'render_type' => 'template',
				'options' => [
					'rectangle' => esc_html__( 'Rectangle', 'crt-manage' ),
					'point' => esc_html__( 'Point', 'crt-manage' ),
				],
				'condition' => [
					'show_chart_legend' => 'yes',
				]
		...
		$this->add_control(
			'tooltips_percent',
			[ 
				'label' => __( 'Convert Values to Percents', 'crt-manage' ),
				'type' => Controls_Manager::SWITCHER,
				'return_value'       => 'true',
				'default' => 'true',
				'frontend_available' => true,
		...
		$this->add_control(
			'trigger_tooltip_on',
			[
				'label'   => esc_html__('Show Tooltip On', 'crt-manage'),
				'type'    => Controls_Manager::SELECT,
				'default' => 'mousemove',
				'options' => [
					'mousemove' => esc_html__('Hover', 'crt-manage'),
		...
		$this->add_control(
			...
			[
				'label'   => esc_html__('Interaction Mode', 'crt-manage'),
				'type'    => Controls_Manager::SELECT,
				'default' => 'point',
				'options' => [
					// 'nearest' => esc_html__('Nearest', 'crt-manage'),
					'point' => esc_html__('Point', 'crt-manage'),
					'index' => esc_html__('Index', 'crt-manage'),
					'dataset' => esc_html__('Dataset', 'crt-manage'),
				],
				'condition' => [
					'show_chart_tooltip' => 'yes'
				]
		...
		$this->add_control(
			...
			[
				...
				'options' => [
					'nearest' => esc_html__('Nearest', 'crt-manage'),
					'average' => esc_html__('Average', 'crt-manage'),
				],
				'condition' => [
					'show_chart_tooltip' => 'yes'
				]
		...
		$this->start_controls_section(
            'section_chart_lines',
			[
				'label' => esc_html__( 'Lines', 'crt-manage' ),
				'tab' => Controls_Manager::TAB_CONTENT,
				'condition' => [
					'chart_type' => ['line', 'radar'],
				]
		...
		$this->add_control(
			'show_lines',
			[
				'label' => esc_html__( 'Show Lines', 'crt-manage' ),
				'type' => Controls_Manager::SWITCHER,
				'default' => 'yes',
				'return_value' => 'yes',
				'separator' => 'before',
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Show Background Fill', 'crt-manage' ),
				'type' => Controls_Manager::SWITCHER,
				'default' => 'yes',
				'return_value' => 'yes',
				'condition' => [
		...
		$this->add_responsive_control(
			'line_dots_radius',
			[
				'label' => esc_html__( 'Dots Size', 'crt-manage' ),
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Responsive', 'crt-manage' ),
				'tab'	=> Controls_Manager::TAB_CONTENT,
			]
		);
			/**
		...
		$this->add_control(
			'responsive_chart',
			[
				'label'		=> esc_html__( 'Responsive Layout', 'crt-manage' ),
				'description' => esc_html__( 'Enables scrollbar on tablet and mobile screens', 'crt-manage' ),
				'default' => 'yes',
				'type'		=> Controls_Manager::SWITCHER,
				'selectors'	=> [
					'{{WRAPPER}} .crt-charts-container'	=> 'overflow: auto;',
					'{{WRAPPER}} .crt-charts-wrapper' => 'position: relative; margin: 0 auto;',
				],
			]
		);
		...
		$this->add_responsive_control(
			'chart_res_width',
			[
				'label'		=> esc_html__( 'Min Width (px)', 'crt-manage' ),
				'type'		=> Controls_Manager::SLIDER,
				'range'		=> [
					'px'	=> [
						'min' => 0,
				...
				'selectors'	=> [
					'{{WRAPPER}} .crt-charts-wrapper' => 'min-width: {{SIZE}}px;',
				],
				'separator'	=> 'before',
				'condition'	=> [
		...
		$this->add_responsive_control(
			'chart_res_height',
			[
				'label'		=> esc_html__( 'Min Height (px)', 'crt-manage' ),
				'type'		=> Controls_Manager::SLIDER,
				'range'		=> [
					'px'	=> [
						'min' => 0,
				...
				'selectors'	=> [
					'{{WRAPPER}} .crt-charts-wrapper' => 'min-height: {{SIZE}}px;',
				],
				'condition'	=> [
					'responsive_chart' => 'yes',
				],
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Data Values', 'crt-manage' ),
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Font Family', 'crt-manage' ),
				'type' => \Elementor\Controls_Manager::FONT,
				'description' => esc_html__('Use only the fonts located under System options group', 'crt-manage'),
				'default' => 'Arial',
			]
		);
		...
		$this->add_control(
			...
			[
				'label'   => esc_html__('Font Style', 'crt-manage'),
				'type'    => Controls_Manager::SELECT,
				'default' => 'normal',
				'options' => [
					'normal' => 'Normal',
		...
		$this->add_control(
			...
			[
				'label'              => __( 'Font Weight ', 'crt-manage' ),
				'type'               => Controls_Manager::NUMBER,
				'min'                => 0,
				'default'            => 600,
				'frontend_available' => true
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Angle Lines', 'crt-manage' ),
				'type' => Controls_Manager::HEADING,
			]
		);
		...
		$this->add_control(
			'axis_labels_heading',
			[
				'label' => esc_html__( 'Axis Labels', 'crt-manage' ),
				'type' => Controls_Manager::HEADING,
				'separator' => 'before',
			]
		);
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Ticks', 'crt-manage' ),
				'type' => Controls_Manager::HEADING,
				'separator' => 'before'
			]
		);
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Grid Lines (X)', 'crt-manage' ),
				'type' => Controls_Manager::HEADING,
				'separator' => 'before',
			]
		);
		...
		$this->add_control(
			'axis_grid_line_color_x', [
				'label'       => esc_html__('Color (X)', 'crt-manage'),
				'type'        => Controls_Manager::COLOR,
				'default' => '#888888'
			]
		);
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Grid Lines (Y)', 'crt-manage' ),
				'type' => Controls_Manager::HEADING,
				'separator' => 'before',
			]
		);
		...
		$this->add_control(
			'axis_grid_line_color_y', [
				'label'       => esc_html__('Color (Y)', 'crt-manage'),
				'type'        => Controls_Manager::COLOR,
				'default' => '#888888'
			]
		);
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'X-Title', 'crt-manage' ),
				'type' => Controls_Manager::HEADING,
				'separator' => 'before',
			]
		);
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Y-Title', 'crt-manage' ),
				'type' => Controls_Manager::HEADING,
				'separator' => 'before',
			]
		);
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'X-Ticks', 'crt-manage' ),
				'type' => Controls_Manager::HEADING,
				'separator' => 'before',
			]
		);
		...
		$this->add_control(
			'chart_ticks_color_x', [
				'label'       => esc_html__('Ticks Color (X)', 'crt-manage'),
				'type'        => Controls_Manager::COLOR,
			]
		);
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Y-Ticks', 'crt-manage' ),
				'type' => Controls_Manager::HEADING,
				'separator' => 'before',
			]
		);
		...
		$this->add_control(
			'chart_ticks_color_y', [
				'label'       => esc_html__('Ticks Color (Y)', 'crt-manage'),
				'type'        => Controls_Manager::COLOR,
			]
		);
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Legend', 'crt-manage' ),
				'tab' => Controls_Manager::TAB_STYLE,
			]
        );
		...
		$this->add_responsive_control(
			'tooltip_caret_size',
			[
				'label' => esc_html__( 'Triangle Size', 'crt-manage' ),
				'type' => Controls_Manager::SLIDER,
				'devices' => ['desktop', 'mobile'],
				'size_units' => [ 'px' ],
				'range' => [
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Tooltip Title', 'crt-manage' ),
				'type' => Controls_Manager::HEADING,
				'separator' => 'before',
			]
		);
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Title Spacing', 'crt-manage' ),
				'type' => Controls_Manager::SLIDER,
				'range' => [
					'px' => [
						'min' => 0,
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Tooltip Item', 'crt-manage' ),
				'type' => Controls_Manager::HEADING,
				'separator' => 'before',
			]
		);
		...
		$this->add_control(
			'chart_tooltip_item_color', [
				'label'       => esc_html__('Item Color', 'crt-manage'),
				'type'        => Controls_Manager::COLOR,
				'default' => '#FFF'
			]
		);
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Item Spacing', 'crt-manage' ),
				'type' => Controls_Manager::SLIDER,
				'range' => [
					'px' => [
						'min' => 0,
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Item Alignment', 'crt-manage' ),
				'type' => Controls_Manager::CHOOSE,
				'default' => 'center',
				'label_block' => false,
				'options' => [
...
//				if ( (!defined('WPR_ADDONS_PRO_VERSION') || !crt_fs()->can_use_premium_code()) && 3 < sizeof($data_charts_array['labels']) ) {
...
//					if ( (!defined('WPR_ADDONS_PRO_VERSION') || !crt_fs()->can_use_premium_code()) && $charts_counter === 3 ) {
//						break;
//					}
...
//					if ( (!defined('WPR_ADDONS_PRO_VERSION') || !crt_fs()->can_use_premium_code()) && $key === 3 ) {
//						break;
//					}
...
//					}
        ...
        echo '<div ' . $this->get_render_attribute_string( 'chart-settings') . '>';
			...
			if ( $data_source === 'csv' ) {
				echo '<span class="crt-rotating-plane"></span>';
			}

            echo '<div class="crt-charts-wrapper">';
                echo '<canvas class="crt-chart"></canvas>';
            echo '</div>';
        echo '</div>';
    }
