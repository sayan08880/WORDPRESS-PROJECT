...
class CRT_Category_Grid extends Widget_Base {
	
	public function get_name() {
		return 'crt-category-grid';
	}

	public function get_title() {
		return esc_html__( 'Category Grid', 'crt-manage' );
	}
	...
	public function get_script_depends() {
        return [ 'crt-manage-isotope', 'crt-manage-lib-slick', 'crt-lightgallery', 'crt-category-grid' ];
    }
...
//		if ( Utilities::is_pro() ) {
//			// Category doesn't seem to natively provide Likes/Sharing controls on free
//		} else {
...
//		}
    ...
    public function register_controls() {
		...
		$this->add_control(
			'thumbnail_term',
			[
				'label' => esc_html__( 'Select Custom Field For Image', 'crt-manage' ),
...
//				'raw' => __( 'How to add Category Thumbnails <ul><li><a href="https://www.youtube.com/watch?v=LqP_kIy_lpA&t=1s" target="_blank" style="color: #93003c;"><strong>Watch Video Tutorial <span class="dashicons dashicons-video-alt3"></strong></a></li></ul>', 'crt-manage' ),
...
//		);
		...
		$this->add_control(
			'query_exclude_tags',
			[
				'label' => esc_html__( 'Exclude Tags', 'crt-manage' ),
				'type' => 'crt-ajax-select2',
				'options' => 'ajaxselect2/get_taxonomies',
				'query_slug' => 'post_tag',
				'multiple' => true,
