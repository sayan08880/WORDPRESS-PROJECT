...
class CRT_Countdown extends Widget_Base {
		
	public function get_name() {
		return 'crt-countdown';
	}

	public function get_title() {
		return esc_html__( 'Countdown', 'crt-manage' );
	}

	public function get_icon() {
		return 'crt-icon eicon-countdown';
	}
	...
	public function get_keywords() {
		return [ 'countdown', 'evergreen countdown timer' ];
	}
	...
	public function add_control_countdown_type() {
        $this->add_control(
            ...
            [
                ...
                'default' => 'due-date',
                'options' => [
                    'due-date' => esc_html__( 'Due Date', 'crt-manage' ),
                    'evergreen' => esc_html__( 'Evergreen', 'crt-manage' ),
                ],
            ]
        );
	}
	...
	public function add_control_evergreen_hours() {
        $this->add_control(
            'evergreen_hours',
            [
                'label' => esc_html__( 'Hours', 'crt-manage' ),
	...
	public function add_control_evergreen_minutes() {
        $this->add_control(
            'evergreen_minutes',
            [
                'label' => esc_html__( 'Minutes', 'crt-manage' ),
                'type' => Controls_Manager::NUMBER,
                'default' => 10,
                'min' => 0,
                'step' => 1,
        ...
        $this->add_control(
            ...
            [
                ...
                'options' => [
                    ...
                    '10000' => esc_html__( '10 Seconds', 'crt-manage' ),//tmp
                    ...
                    '2628000000' => esc_html__( 'Month', 'crt-manage' ),
                ],
                'separator' => 'before',
                'condition' => [
                    'countdown_type' => 'evergreen',
	...
	public function add_control_evergreen_stop_after_date() {
		$this->add_control(
			...
			[
				'label' => __( 'Stop Showing after Date', 'crt-manage' ),
...
//				'classes' => ''
	...
	public function add_control_evergreen_stop_after_date_select() {
        $this->add_control(
            ...
            [
                ...
                'description' => sprintf( __( 'Set according to your WordPress timezone: %s.', 'crt-manage' ), Utils::get_timezone_string() ),
                'condition' => [
                    'evergreen_stop_after_date!' => '',
                    'countdown_type' => 'evergreen',
                ],
	...
	protected function register_controls() {
		...
		$this->add_control(
			'due_date',
			[
				'label' => esc_html__( 'Due Date', 'crt-manage' ),
				'type' => Controls_Manager::DATE_TIME,
				'default' => $due_date_default,
				'description' => sprintf(
					esc_html__( 'Date set according to your timezone: %s.', 'crt-manage' ),
		...
		$this->add_control(
			'show_days',
			[
				'label' => esc_html__( 'Show Days', 'crt-manage' ),
				'type' => Controls_Manager::SWITCHER,
				'default' => 'yes',
				'separator' => 'before',
			]
		...
		$this->add_control(
			'show_hours',
			[
				'label' => esc_html__( 'Show Hours', 'crt-manage' ),
				'type' => Controls_Manager::SWITCHER,
				'default' => 'yes'
			]
		);
		...
		$this->add_control(
			'show_minutes',
			[
				'label' => esc_html__( 'Show Minutes', 'crt-manage' ),
				'type' => Controls_Manager::SWITCHER,
				'default' => 'yes'
			]
		);
		...
		$this->add_control(
			'show_seconds',
			[
				'label' => esc_html__( 'Show Seconds', 'crt-manage' ),
				'type' => Controls_Manager::SWITCHER,
				'default' => 'yes'
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .crt-countdown-number' => 'display: {{VALUE}}',
					'{{WRAPPER}} .crt-countdown-label' => 'display: {{VALUE}}',
				],
				'separator' => 'after',	
				'condition' => [
					'show_labels' => 'yes',
		...
		$this->add_control(
			'labels_days_plural',
			[
				'label' => esc_html__( 'Days', 'crt-manage' ),
				'type' => Controls_Manager::TEXT,
				'dynamic' => [
					'active' => true,
				],
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Hour', 'crt-manage' ),
				'type' => Controls_Manager::TEXT,
				'dynamic' => [
					'active' => true,
				],
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Minute', 'crt-manage' ),
				'type' => Controls_Manager::TEXT,
				'dynamic' => [
					'active' => true,
				],
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Seconds', 'crt-manage' ),
				'type' => Controls_Manager::TEXT,
				'dynamic' => [
					'active' => true,
				],
		...
		$this->add_control(
			'show_separator',
			[
				'label' => esc_html__( 'Show Separators', 'crt-manage' ),
				'type' => Controls_Manager::SWITCHER,
				'separator' => 'before',
			]
		);
		...
		$this->start_controls_section(
			'section_actions',
			[
				'label' => esc_html__( 'Expire Actions', 'crt-manage' ),
			]
		);
		...
		$this->add_control(
			'timer_actions',
			[
				'label' => esc_html__( 'Actions After Timer Expires', 'crt-manage' ),
				'label_block' => true,
				'type' => Controls_Manager::SELECT2,
				'options' => [
					'hide-timer' => esc_html__( 'Hide Timer', 'crt-manage' ),
					'hide-element' => esc_html__( 'Hide Element', 'crt-manage' ),
					'message' => esc_html__( 'Display Message', 'crt-manage' ),
					'redirect' => esc_html__( 'Redirect', 'crt-manage' ),
					'load-template' => esc_html__( 'Load Template', 'crt-manage' ),
				],
				'multiple' => true,
				'separator' => 'before',
			]
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'CSS Selector to Hide Element', 'crt-manage' ),
				'label_block' => true,
				'type' => Controls_Manager::TEXT,
				'dynamic' => [
					'active' => true,
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Display Message', 'crt-manage' ),
		...
		$this->add_control(
			'redirect_url',
			[
				'label' => esc_html__( 'Redirect URL', 'crt-manage' ),
				'label_block' => true,
				'type' => Controls_Manager::TEXT,
				'dynamic' => [
					'active' => true,
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .crt-countdown-item'
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .crt-countdown-wrap' => 'max-width: {{SIZE}}{{UNIT}};',
				],
				'separator' => 'before',
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .crt-countdown-item' => 'margin-left: calc({{SIZE}}px/2);margin-right: calc({{SIZE}}px/2);',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => [ 'px' ],
				'selectors' => [
					'{{WRAPPER}} .crt-countdown-item' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
				'separator' => 'before',
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .crt-countdown-item' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
				'separator' => 'before',
			]
		);
		...
		$this->add_responsive_control(
            ...
            [
				...
				'selectors' => [
					'{{WRAPPER}} .crt-countdown-item' => 'text-align: {{VALUE}}',
				],
				'separator' => 'after'
            ]
        );
		...
		$this->add_control(
			'numbers_color',
			[
				'label' => esc_html__( 'Numbers Color', 'crt-manage' ),
				'type' => Controls_Manager::COLOR,
				'default' => '#ffffff',
				'selectors' => [
					'{{WRAPPER}} .crt-countdown-number' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			'numbers_bg_color',
			[
				'label' => esc_html__( 'Numbers Background Color', 'crt-manage' ),
				'type' => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .crt-countdown-number' => 'background-color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .crt-countdown-number',
			]
		);
		...
		$this->add_responsive_control(
			'numbers_padding',
			[
				'label' => esc_html__( 'Numbers Padding', 'crt-manage' ),
				'type' => Controls_Manager::DIMENSIONS,
				'default' => [
					'top' => 40,
					'right' => 10,
				...
				'size_units' => [ 'px' ],
				'selectors' => [
					'{{WRAPPER}} .crt-countdown-number' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_control(
			'labels_color',
			[
				'label' => esc_html__( 'Labels Color', 'crt-manage' ),
				'type' => Controls_Manager::COLOR,
				'default' => '#ffffff',
				'selectors' => [
					'{{WRAPPER}} .crt-countdown-label' => 'color: {{VALUE}};',
				],
	            'separator' => 'before'
			]
		);
		...
		$this->add_control(
			'labels_bg_color',
			[
				'label' => esc_html__( 'Labels Background Color', 'crt-manage' ),
				'type' => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .crt-countdown-label' => 'background-color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .crt-countdown-label',
			]
		);
		...
		$this->add_responsive_control(
			'labels_padding',
			[
				'label' => esc_html__( 'Labels Padding', 'crt-manage' ),
				'type' => Controls_Manager::DIMENSIONS,
				'default' => [
					'top' => 10,
					'right' => 10,
				...
				'size_units' => [ 'px' ],
				'selectors' => [
					'{{WRAPPER}} .crt-countdown-label' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default' => '#605BE5',
				'selectors' => [
					'{{WRAPPER}} .crt-countdown-separator span' => 'background: {{VALUE}};',
				],
				'separator' => 'before',
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .crt-countdown-separator span' => 'width: {{SIZE}}{{UNIT}}; height: {{SIZE}}{{UNIT}};',
				],
				'condition' => [
					'show_separator' => 'yes',
				],
		...
		$this->add_responsive_control(
			'separator_margin',
			[
				'label' => esc_html__( 'Dots Margin', 'crt-manage' ),
				'type' => Controls_Manager::SLIDER,
				'size_units' => [ 'px' ],
				'range' => [
					'px' => [
				...
				'selectors' => [
					'{{WRAPPER}} .crt-countdown-separator span:first-child' => 'margin-bottom: {{SIZE}}{{UNIT}};',
				],
				'condition' => [
					'show_separator' => 'yes',
				],
		...
		$this->add_control(
			'separator_circle',
			[
				'label' => esc_html__( 'Separator Border Radius', 'crt-manage' ),
				'type' => Controls_Manager::SWITCHER,
				'default' => 'yes',
				'selectors_dictionary' => [
					'yes' => '50%;',
				...
				'selectors' => [
					'{{WRAPPER}} .crt-countdown-separator span' => 'border-radius: {{VALUE}};',
				],
			]
		);
		...
		$this->add_responsive_control(
            ...
            [
				...
				'selectors' => [
					'{{WRAPPER}} .crt-countdown-message' => 'text-align: {{VALUE}}',
				],
            ]
        );
		...
		$this->add_control(
			...
			[
				...
				'default' => '#ffffff',
				'selectors' => [
					'{{WRAPPER}} .crt-countdown-message' => 'color: {{VALUE}};',
				],
	            'separator' => 'before'
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type' => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .crt-countdown-message' => 'background-color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .crt-countdown-message',
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => [ 'px' ],
				'selectors' => [
					'{{WRAPPER}} .crt-countdown-message' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
				'separator' => 'before',
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .crt-countdown-message' => 'margin-top: {{SIZE}}{{UNIT}};',
				],
			]
		);
	...
	public function get_countdown_class( $settings ) {
		...
		$class = 'crt-countdown-wrap elementor-clearfix';
	...
	public function render_countdown_item( $settings, $item ) {
		$html = '<div class="crt-countdown-item">';
			$html .= '<span class="crt-countdown-number crt-countdown-'. esc_attr($item) .'" data-item="'. esc_attr($item) .'"></span>';
			...
			if ( 'yes' === $settings['show_labels'] ) {
				if ( 'seconds' !== $item ) {
					...
					$html .= '<span class="crt-countdown-label" data-text="'. esc_attr(json_encode( $labels )) .'">'. esc_html($settings['labels_'. $item .'_plural']) .'</span>';
				} else {
					$html .= '<span class="crt-countdown-label">'. esc_html($settings['labels_'. $item .'_plural']) .'</span>';
				}
			}
		$html .= '</div>';

		if ( $settings['show_separator'] ) {
			$html .= '<span class="crt-countdown-separator"><span></span><span></span></span>';
		}
