...
class CRT_Magazine_Grid extends Widget_Base {
	
	public function get_name() {
		return 'crt-magazine-grid';
	}

	public function get_title() {
		return esc_html__( 'Magazine Grid/Slider', 'crt-manage' );
	}
	...
	public function get_script_depends() {
		return [ 'crt-manage-isotope', 'crt-manage-lib-slick', 'crt-magazine-grid' ];
	}

	public function get_style_depends() {
        return [ 'crt-animations-css', 'crt-link-animations-css', 'crt-button-animations-css', 'crt-loading-animations-css'];
	}
	...
	public function add_option_query_source() {
		...
		$post_types['curent'] = esc_html__( 'Current Query', 'crt-manage' );
		$post_types['related'] = esc_html__( 'Related Query', 'crt-manage' );
	...
	public function add_control_query_randomize() {
		$this->add_control(
			'query_randomize',
			[
				'label' => __( 'Randomize Query', 'crt-manage' ),
				'type' => Controls_Manager::SWITCHER,
				'classes' => 'no-distance'
			]
		);
        ...
        $this->add_control(
			...
			[
				...
				'options' => [
                    ...
                    'modified' => esc_html__( 'Last Modified', 'crt-manage'),
                    'ID' => esc_html__( 'Post ID', 'crt-manage' ),
                    'author' => esc_html__( 'Post Author', 'crt-manage' ),
                    'comment_count' => esc_html__( 'Comment Count', 'crt-manage' ),
				],
				'condition' => [
	...
	public function add_control_force_responsive_one_column() {
		$this->add_control(
			...
			[
				'label' => __( 'Force Responsive One Column', 'crt-manage' ),
				'type' => Controls_Manager::SWITCHER,
				'classes' => ''
			]
		);
    ...
    public function add_section_slider() {
        $this->start_controls_section(
            'section_slider',
            [
                'label' => esc_html__( 'Posts Slider', 'crt-manage' ),
        ...
        $this->add_control(
            'slider_enable',
            [
                'label' => esc_html__( 'Enable Slider', 'crt-manage' ),
                'type' => Controls_Manager::SWITCHER,
                'return_value' => 'yes',
            ]
        );
        ...
        $this->add_control(
            'slider_amount',
            [
                'label' => esc_html__( 'Number of Slides', 'crt-manage' ),
	...
	protected function register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'options' => [
					'1-2' => [
						'title' => esc_html__( 'Layout 1 (3 posts)', 'crt-manage' ),
					],
					'1-3' => [
						'title' => esc_html__( 'Layout 2 (4 posts)', 'crt-manage' ),
					],
					'1-4' => [
						'title' => esc_html__( 'Layout 3 (5 posts)', 'crt-manage' ),
					],
					'1-1-2' => [
						'title' => esc_html__( 'Layout 4 (4 posts)', 'crt-manage' ),
					],
					'2-1-2' => [
						'title' => esc_html__( 'Layout 5 (5 posts)', 'crt-manage' ),
					],
					'1vh-3h' => [
						'title' => esc_html__( 'Layout 5.0 (4 posts)', 'crt-manage' ),
					],
					'1-1-1' => [
						'title' => esc_html__( 'Layout 5.1 (3 posts)', 'crt-manage' ),
					],
					'1-1-3' => [
						'title' => esc_html__( 'Layout 5.2 (5 posts)', 'crt-manage' ),
					],
					'2-3' => [
						'title' => esc_html__( 'Layout 6 (5 posts)', 'crt-manage' ),
					],
					'2-h' => [
						'title' => esc_html__( 'Layout 7 (2, 4, 6 posts)', 'crt-manage' ),
					],
					'3-h' => [
						'title' => esc_html__( 'Layout 8 (3, 6, 9 posts)', 'crt-manage' ),
					],
					'4-h' => [
						'title' => esc_html__( 'Layout 8 (4, 8, 12 posts)', 'crt-manage' ),
					]
				],
			]
		);
		...
		$this->add_control(
			'layout_rows_number',
			[
				'label' => esc_html__( 'Rows Number', 'crt-manage' ),
				'type' => Controls_Manager::SELECT,
				'render_type' => 'template',
				'default' => '1',
				'options' => [
					'1' => esc_html__( '1 Row', 'crt-manage' ),
					'2' => esc_html__( '2 Rows', 'crt-manage' ),
					'3' => esc_html__( '3 Rows', 'crt-manage' ),
				],
				'selectors' => [
					'{{WRAPPER}} .crt-mgzn-grid-2-h' => 'grid-template-rows: repeat({{VALUE}}, 1fr);',
					'{{WRAPPER}} .crt-mgzn-grid-3-h' => 'grid-template-rows: repeat({{VALUE}}, 1fr);',
					'{{WRAPPER}} .crt-mgzn-grid-4-h' => 'grid-template-rows: repeat({{VALUE}}, 1fr);',
				],
				'condition' => [
		...
		$this->add_responsive_control(
			...
			[
				'type' => Controls_Manager::SLIDER,
				'label' => esc_html__( 'Container Height', 'crt-manage' ),
				'size_units' => [ 'px', 'vh' ],
				'range' => [
					'px' => [
						'min' => 100,
				...
				'selectors' => [
					'{{WRAPPER}} .crt-magazine-grid' => 'min-height: {{SIZE}}{{UNIT}};',
				],
				'separator' => 'before'
			]
		);
		...
		$this->add_control(
			...
			[
				'type' => Controls_Manager::SLIDER,
				'label' => esc_html__( 'Featured Box Width', 'crt-manage' ),
				'range' => [
					'%' => [
						'min' => 10,
						'max' => 100,
				...
				'selectors' => [
					'{{WRAPPER}} .crt-mgzn-grid-1-2' => 'grid-template-columns: {{SIZE}}% 1fr; -ms-grid-columns: {{SIZE}}% 1fr;',
					'{{WRAPPER}} .crt-mgzn-grid-1-3' => 'grid-template-columns: {{SIZE}}% 1fr 1fr; -ms-grid-columns: {{SIZE}}% 1fr 1fr;',
					'{{WRAPPER}} .crt-mgzn-grid-1-4' => 'grid-template-columns: {{SIZE}}% 1fr 1fr; -ms-grid-columns: {{SIZE}}% 1fr 1fr;',
					'{{WRAPPER}} .crt-mgzn-grid-1-1-2' => 'grid-template-columns: {{SIZE}}% 1fr 1fr; -ms-grid-columns: {{SIZE}}% 1fr 1fr;',
					'{{WRAPPER}} .crt-mgzn-grid-1vh-3h' => 'grid-template-columns: {{SIZE}}% 1fr; -ms-grid-columns: {{SIZE}}% 1fr;',
					'{{WRAPPER}} .crt-mgzn-grid-2-1-2' => 'grid-template-columns: 1fr {{SIZE}}% 1fr; -ms-grid-columns: 1fr {{SIZE}}% 1fr;',
					'{{WRAPPER}} .crt-mgzn-grid-1-1-1' => 'grid-template-columns: 1fr {{SIZE}}% 1fr; -ms-grid-columns: 1fr {{SIZE}}% 1fr;',
				],
				'condition' => [
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .crt-magazine-grid' => 'grid-column-gap: {{SIZE}}px;',
				],
				'separator' => 'before'
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .crt-magazine-grid' => 'grid-row-gap: {{SIZE}}px;',
				],
				'separator' => 'after'
			]
		);
		...
		$repeater->add_control(
			...
			[
				'raw' => esc_html__( 'Watch Custom Fields ', 'crt-manage' ) . sprintf( '<a href="%1$s" target="_blank">%2$s <span class="dashicons dashicons-video-alt3"></span></a>', 'https://www.youtube.com/watch?v=9GvpqyHF_Cs', esc_html__( 'Video Tutorial', 'crt-manage' ) ),
		...
		$this->add_responsive_control(
			...
			[
				'type' => Controls_Manager::SLIDER,
				'label' => esc_html__( 'Featured Box Title Font Size', 'crt-manage' ),
				'range' => [
					'px' => [
						'min' => 10,
						'max' => 100,
				...
				'selectors' => [
					'{{WRAPPER}} .crt-mgzn-grid-1-2 article:nth-child(1) .crt-grid-item-title a' => 'font-size: {{SIZE}}px;',
					'{{WRAPPER}} .crt-mgzn-grid-1-3 article:nth-child(1) .crt-grid-item-title a' => 'font-size: {{SIZE}}px;',
					'{{WRAPPER}} .crt-mgzn-grid-1-4 article:nth-child(1) .crt-grid-item-title a' => 'font-size: {{SIZE}}px;',
					'{{WRAPPER}} .crt-mgzn-grid-1-1-2 article:nth-child(1) .crt-grid-item-title a' => 'font-size: {{SIZE}}px;',
					'{{WRAPPER}} .crt-mgzn-grid-2-1-2 article:nth-child(2) .crt-grid-item-title a' => 'font-size: {{SIZE}}px;',
					'{{WRAPPER}} .crt-mgzn-grid-1vh-3h article:nth-child(1) .crt-grid-item-title a' => 'font-size: {{SIZE}}px;',
					'{{WRAPPER}} .crt-mgzn-grid-1-1-1 article:nth-child(2) .crt-grid-item-title a' => 'font-size: {{SIZE}}px;',
				],
				'condition' => [
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .crt-grid-item-date'
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .crt-grid-item-author'
			]
		);
	...
	public function render_post_thumbnail( $settings ) {
		...
		if ( has_post_thumbnail() ) {
			echo '<div class="crt-grid-image-wrap" data-src="'. esc_url( $src ) .'" style="background-image: url('. esc_url( $src ) .')"></div>';
		}
	}

	// Render Media Overlay
	public function render_media_overlay( $settings ) {
		echo '<div class="crt-grid-media-hover-bg '. esc_attr($this->get_animation_class( $settings, 'overlay' )) .'" data-url="'. esc_url( get_the_permalink( get_the_ID() ) ) .'">';
	...
	public function render_post_title( $settings, $class ) {
		$title_pointer = $this->get_settings()['title_pointer'];
		$title_pointer_animation = $this->get_settings()['title_pointer_animation'];
		$pointer_item_class = (isset($this->get_settings()['title_pointer']) && 'none' !== $this->get_settings()['title_pointer']) ? 'class="crt-pointer-item"' : '';
	...
	public function render_post_read_more( $settings, $class ) {
		$read_more_animation =  $this->get_settings()['read_more_animation'];
		$open_links_in_new_tab = 'yes' === $this->get_settings()['open_links_in_new_tab'] ? '_blank' : '_self';
	...
	public function render_post_likes( $settings, $class, $post_id ) {
		$post_likes = new \CrtAddons\Classes\Modules\CRT_Post_Likes();
	...
	public function render_magazine_grid( $settings, $slide_offset ) {
		...
		echo '<section class="crt-magazine-grid crt-mgzn-grid-'. esc_attr($settings['layout_select']) .' crt-mgzn-grid-rows-'. esc_attr($settings['layout_rows_number']) .'">';
		...
		while ( $posts->have_posts() ) : $posts->the_post();
			...
			// Post Class
			$post_class = implode( ' ', get_post_class( 'crt-mgzn-grid-item elementor-clearfix', get_the_ID() ) );
			...
			// Media
			echo '<div class="crt-grid-media-wrap" data-overlay-link="'. esc_attr( $settings['overlay_post_link'] ) .'">';
				// Post Thumbnail
	...
	protected function render() {
		...
		// Grid/Slider Wrap
		echo '<div class="crt-magazine-grid-wrap" '. $render_attribute .' data-slide-effect="'. esc_attr($settings['slider_effect']) .'">';

		// Slider
		if ( 'yes' === $settings['slider_enable'] ) {

			for ( $i=0; $i < $settings['slider_amount']; $i++ ) { 
				echo '<div class="crt-magazine-slide">';
		...
		if ( 'yes' === $settings['slider_enable'] ) {
			echo '<div class="crt-grid-slider-arrow-container">';
				echo '<div class="crt-grid-slider-prev-arrow crt-grid-slider-arrow" id="crt-grid-slider-prev-'. esc_html($this->get_id()) .'">'. Utilities::get_crt_icon( $settings['slider_nav_icon'], '' ) .'</div>'; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
				echo '<div class="crt-grid-slider-next-arrow crt-grid-slider-arrow" id="crt-grid-slider-next-'. esc_html($this->get_id()) .'">'. Utilities::get_crt_icon( $settings['slider_nav_icon'], '' ) .'</div>'; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
			echo '</div>';
		}
