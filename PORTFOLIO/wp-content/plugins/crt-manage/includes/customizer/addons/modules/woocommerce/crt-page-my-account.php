...
class CRT_Page_My_Account extends Widget_Base {
	
	public function get_name() {
		return 'crt-my-account';
	}

	public function get_title() {
		return esc_html__( 'My Account', 'crt-manage' );
	}

	public function get_icon() {
		return 'crt-icon eicon-my-account';
	}
	...
	public function get_keywords() {
		return [ 'account', 'product', 'page', 'account page', 'page account', 'My Account', 'woocommerce' ];
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'prefix_class' => 'crt-my-account-tabs-',
			]
		);
		...
		$this->add_control( //TODO: change approach
			'tabs_alignment',
			[
				'label' => esc_html__( 'Tabs Align', 'crt-manage' ),
				'type' => Controls_Manager::CHOOSE,
				'default' => 'center',
				'label_block' => false,
				'options' => [
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					// '{{WRAPPER}}.crt-my-account-tabs-horizontal .woocommerce-MyAccount-navigation' => 'margin-bottom: {{SIZE}}{{UNIT}};',
					// '{{WRAPPER}}.crt-my-account-tabs-vertical .woocommerce-MyAccount-navigation' => 'margin-right: {{SIZE}}{{UNIT}};',
					// '{{WRAPPER}}.crt-my-account-tabs-vertical .woocommerce-MyAccount-content' => 'width: calc(70% - {{SIZE}}px);'
					'{{WRAPPER}}.crt-my-account-tabs-horizontal .woocommerce-MyAccount-content' => 'margin-top: {{SIZE}}{{UNIT}};',
					'{{WRAPPER}}.crt-my-account-tabs-vertical .woocommerce-MyAccount-content' => 'margin-left: {{SIZE}}{{UNIT}};',
					'{{WRAPPER}}.crt-my-account-tabs-vertical .woocommerce-MyAccount-content' => 'width: calc(100% - {{tab_width.SIZE}}px - {{SIZE}}px);',
					'[data-elementor-device-mode="mobile"] {{WRAPPER}}.crt-my-account-tabs-vertical .woocommerce-MyAccount-content' => 'width: calc(100%  - {{tab_width_mobile.SIZE}}px - {{SIZE}}px);'
				],
				'separator' => 'before',
			]
		);
		...
		$repeater->add_control(
			'tab_label_name',
			[
				'label' => esc_html__( 'Tab Name', 'crt-manage' ),
		...
		$this->add_control(
			...
			[
				...
				'default' => [
					[
						'field_key' => 'dashboard',
						'field_label' => esc_html__( 'Dashboard', 'crt-manage' ),
						'tab_label_name' => esc_html__( 'Dashboard', 'crt-manage' ),
					],
					[
						'field_key' => 'orders',
						'field_label' => esc_html__( 'Orders', 'crt-manage' ),
						'tab_label_name' => esc_html__( 'Orders', 'crt-manage' ),
					],
					[
						'field_key' => 'downloads',
						'field_label' => esc_html__( 'Downloads', 'crt-manage' ),
						'tab_label_name' => esc_html__( 'Downloads', 'crt-manage' ),
					],
					[
						'field_key' => 'edit-address',
						'field_label' => esc_html__( 'Addresses', 'crt-manage' ),
						'tab_label_name' => esc_html__( 'Addresses', 'crt-manage' ),
					],
					[
						'field_key' => 'edit-account',
						'field_label' => esc_html__( 'Account Details', 'crt-manage' ),
						'tab_label_name' => esc_html__( 'Account Details', 'crt-manage' ),
					],
					[
						'field_key' => 'wishlist',
						'field_label' => esc_html__( 'Wishlist', 'crt-manage' ),
						'tab_label_name' => esc_html__( 'Wishlist', 'crt-manage' ),
					],
					[
						'field_key' => 'customer-logout',
						'field_label' => esc_html__( 'Logout', 'crt-manage' ),
						'tab_label_name' => esc_html__( 'Logout', 'crt-manage' ),
					],
				],
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}}.crt-my-account-tabs-vertical .woocommerce-MyAccount-navigation' => 'width: {{SIZE}}px'
				],
				'condition' => [
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Tab Content', 'crt-manage' ),
				'tab' => Controls_Manager::TAB_STYLE,
			]
		);
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Headings Distance', 'crt-manage' ),
				'type' => Controls_Manager::SLIDER,
				'size_units' => ['px'],
				'range' => [
					'px' => [
		...
		$this->start_controls_section(
			...
			[
				'label' => __( 'Orders Table', 'crt-manage' ),
				'tab'   => Controls_Manager::TAB_STYLE,
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'label' => esc_html__( 'Table Heading', 'crt-manage' ),
			]
		);
		...
		$this->add_control(
			...
			[
				'type' => Controls_Manager::HEADING,
				'label' => esc_html__( 'Table Description', 'crt-manage' ),
				'separator' => 'before'
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .crt-wishlist-products img' => 'width: {{SIZE}}{{UNIT}};',
				],
				'separator' => 'after',
			]
		);
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Table Buttons', 'crt-manage' ),
				'tab' => Controls_Manager::TAB_STYLE,
				'show_label' => false,
			]
		);
		...
		$this->add_control(
			...
			[
				'type' => Controls_Manager::HEADING,
				'label' => esc_html__( 'Sub-Labels', 'crt-manage' ),
				'separator' => 'before'
			]
		);
		...
		$this->add_control(
			'fieldset_distance',
			[
				'label' => esc_html__( 'Change Password Distance', 'crt-manage' ),
				'type' => Controls_Manager::SLIDER,
				'size_units' => ['px'],
				'range' => [
					'px' => [
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Form Buttons', 'crt-manage' ),
				'tab' => Controls_Manager::TAB_STYLE,
				'show_label' => false,
			]
		);
		...
		$this->start_controls_section(
			'section_style_btn',
			[
				'label' => esc_html__( 'Notice Buttons', 'crt-manage' ),
				'tab' => Controls_Manager::TAB_STYLE,
				'show_label' => false,
			]
		);
	...
	public function woocommerce_logout_default_redirect_url( $redirect ) {
		return $redirect . '?crt-addons_wc_logout=true&crt-addons_my_account_redirect=' . esc_url( get_permalink() );
	} // TODO: what to use instead crt-addons prefix
	
	private function render_html_front_end() {
		$current_endpoint = $this->get_current_endpoint();
		?>
		<div class="crt-my-account-tab crt-my-account-tab__<?php echo sanitize_html_class( $current_endpoint ); ?>">
	...
	private function render_html_editor() {
		...
		<div class="crt-my-account-tab">
			...
			foreach ( $pages as $page => $page_value ) {
				...
				?>
				<div class="woocommerce-MyAccount-content" <?php echo $page ? 'crt-my-account-page="' . esc_attr( $page ) . '"' : ''; ?>>
	...
	public function wishlist_content() {
		...
		echo '<h3>' . __( 'My Wishlist', 'crt-manage' ) . '</h3>';
		echo '<table class="crt-wishlist-products">';
			echo '<thead>';
				echo '<tr>';
					echo '<th></th>';
    ...
    protected function render() {
		...
		if ( get_option('crt_add_wishlist_to_my_account') == 'on' ) {
