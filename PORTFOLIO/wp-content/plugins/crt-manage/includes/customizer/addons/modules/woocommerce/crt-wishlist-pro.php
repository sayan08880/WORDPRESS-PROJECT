...
class CRT_Wishlist_Pro extends Widget_Base {
	
	public function get_name() {
		return 'crt-wishlist-pro';
	}

	public function get_title() {
		return esc_html__( 'Wishlist Table', 'crt-manage' );
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'default' => 'solid',
				'selectors' => [
					'{{WRAPPER}} .crt-wishlist-table' => 'border-style: {{VALUE}};',
					'{{WRAPPER}} .crt-wishlist-table th' => 'border-style: {{VALUE}};',
					'{{WRAPPER}} .crt-wishlist-table td' => 'border-style: {{VALUE}};'
				],
				'separator' => 'before'
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default' => '#E4E4E4',
				'selectors' => [
					'{{WRAPPER}} .crt-wishlist-table' => 'border-color: {{VALUE}};',
					'{{WRAPPER}} .crt-wishlist-table th' => 'border-color: {{VALUE}};',
					'{{WRAPPER}} .crt-wishlist-table td' => 'border-color: {{VALUE}};'
				]
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .crt-wishlist-table' => 'border-width: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
					'{{WRAPPER}} .crt-wishlist-table th' => 'border-width: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
					'{{WRAPPER}} .crt-wishlist-table td' => 'border-width: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
				'condition' => [
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					...
					'{{WRAPPER}} .crt-wishlist-table' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}} !important;'
				]
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default' => '#222',
				'selectors' => [
					'{{WRAPPER}} .crt-wishlist-table tr th' => 'color: {{VALUE}}'
				]
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default' => '#FFF',
				'selectors' => [
					'{{WRAPPER}} .crt-wishlist-table tr th' => 'background-color: {{VALUE}}'
				]
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}}  .crt-wishlist-table tr th'
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .crt-wishlist-table th' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
				'separator' => 'before',
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				'label' => esc_html__( 'Headings Align', 'crt-manage' ),
				...
				'selectors' => [
					'{{WRAPPER}} .crt-wishlist-table th' => 'text-align: {{VALUE}};',
				]
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default' => '#222',
				'selectors' => [
					'{{WRAPPER}} .crt-wishlist-table tr:nth-child(odd) td' => 'color: {{VALUE}}'
				]
			]
		);
		...
		$this->add_control(
			...
			[
				'label'  => esc_html__( 'Color (Even)', 'crt-manage' ),
				'type' => Controls_Manager::COLOR,
				'default' => '#222',
				'selectors' => [
					'{{WRAPPER}} .crt-wishlist-table tr:nth-child(even) td' => 'color: {{VALUE}}'
				]
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default' => '#FFF',
				'selectors' => [
					'{{WRAPPER}} .crt-wishlist-table tr:nth-child(odd) td' => 'background-color: {{VALUE}}'
				]
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default' => '#FFF',
				'selectors' => [
					'{{WRAPPER}} .crt-wishlist-table tr:nth-child(even) td' => 'background-color: {{VALUE}}'
				]
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}}  .crt-wishlist-table tr td',
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .crt-wishlist-table td' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
				'separator' => 'before',
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'separator' => 'after',
				'selectors' => [
					'{{WRAPPER}} .crt-wishlist-table td' => 'text-align: {{VALUE}};'
				]
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .crt-wishlist-product-name' => 'color: {{VALUE}}',
				],
				'separator' => 'after'
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .crt-wishlist-img-wrap' => 'width: {{SIZE}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type' => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .crt-wishlist-remove' => 'background-color: {{VALUE}}!important;',
				]
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default' => '#333333',
				'selectors' => [
					'{{WRAPPER}} .crt-wishlist-product-atc a' => 'color: {{VALUE}}',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type' => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .crt-wishlist-product-atc a' => 'background-color: {{VALUE}}',
				]
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default' => '#E8E8E8',
				'selectors' => [
					'{{WRAPPER}} .crt-wishlist-product-atc a' => 'border-color: {{VALUE}}',
				],
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .crt-wishlist-product-atc a',
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default' => '#605BE5',
				'selectors' => [
					'{{WRAPPER}} .crt-wishlist-product-atc a:hover' => 'color: {{VALUE}}',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type' => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .crt-wishlist-product-atc a.crt-button-none:hover' => 'background-color: {{VALUE}}',
					'{{WRAPPER}} .crt-wishlist-product-atc a.added_to_cart:hover' => 'background-color: {{VALUE}}',
					'{{WRAPPER}} .crt-wishlist-product-atc a:hover' => 'background-color: {{VALUE}}',
					'{{WRAPPER}} .crt-wishlist-product-atc a:before' => 'background-color: {{VALUE}}',
					'{{WRAPPER}} .crt-wishlist-product-atc a:after' => 'background-color: {{VALUE}}',
				]
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default' => '#605BE5',
				'selectors' => [
					'{{WRAPPER}} .crt-wishlist-product-atc a:hover' => 'border-color: {{VALUE}}',
				]
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .crt-wishlist-product-atc :hover a',
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'step' => 0.1,
				'selectors' => [
					'{{WRAPPER}} .crt-wishlist-product-atc a' => 'transition-duration: {{VALUE}}s',
					'{{WRAPPER}} .crt-wishlist-product-atc a:before' => 'transition-duration: {{VALUE}}s',
					'{{WRAPPER}} .crt-wishlist-product-atc a:after' => 'transition-duration: {{VALUE}}s',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default' => 'solid',
				'selectors' => [
					'{{WRAPPER}} .crt-wishlist-product-atc a' => 'border-style: {{VALUE}};',
				],
				'render_type' => 'template',
				'separator' => 'before',
			]
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .crt-wishlist-product-atc a' => 'border-width: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
				'render_type' => 'template',
				'condition' => [
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .crt-wishlist-product-atc a' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
				'separator' => 'before',
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .crt-wishlist-product-atc' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
				'render_type' => 'template',
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .crt-wishlist-product-atc a' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
				'render_type' => 'template',
				'separator' => 'before',
			]
    ...
    protected function render() {
        ...
        if ( ! $wishlist ) {
			echo '<p class="crt-wishlist-empty">'. $settings['wishlist_empty_text'].'</p>'; 
			$this->add_render_attribute('wrapper', 'class', 'crt-wishlist-empty-hidden');
        } else {
			echo '<p class="crt-wishlist-empty crt-wishlist-empty-hidden">'. $settings['wishlist_empty_text'].'</p>';
		}
		
		echo '<div '. $this->get_render_attribute_string('wrapper') .'>';
		echo '<table class="crt-wishlist-table">';
			echo '<thead>';
				echo '<tr>';
					echo '<th></th>';
					echo '<th>'. esc_html__('Product', 'crt-manage') .'</th>';
					echo '<th>'. esc_html__('Name', 'crt-manage') .'</th>';
					echo '<th>'. esc_html__('Price', 'crt-manage') .'</th>';
					echo '<th>'. esc_html__('Stock Status', 'crt-manage') .'</th>';
					echo '<th></th>';
				echo '</tr>';
			echo '</thead>';
			echo '<tbody>';
				foreach ( $wishlist as $product_id ) {
					...
					$stock_status = $product->get_stock_status() == 'instock' ? esc_html__('In Stock', 'crt-manage') : esc_html__('Out of Stock', 'crt-manage');

					echo '<tr class="crt-wishlist-product" data-product-id="' . $product->get_id() . '">';
						echo '<td><span class="crt-wishlist-remove" data-product-id="' . $product->get_id() . '"></span></td>';
						echo '<td><a class="crt-wishlist-img-wrap" href="' . $product->get_permalink() . '">' . $product->get_image() . '</a></td>';
						echo '<td><a class="crt-wishlist-product-name" href="' . $product->get_permalink() . '">' . $product->get_name() . '</a></td>';
						echo '<td><div class="crt-wishlist-product-price">' . $product->get_price_html() . '</div></td>';
						echo '<td><div class="crt-wishlist-product-status">' . $stock_status . '</div></td>';
						echo '<td><div class="crt-wishlist-product-atc">' . $this->render_product_add_to_cart( $settings, $product ) . '</div></td>';
					echo '</tr>';
				}
			echo '</tbody>';
		echo '</table>';
