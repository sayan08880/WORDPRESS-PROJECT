...
class CRT_Product_AddToCart extends Widget_Base {
	
	public function get_name() {
		return 'crt-product-add-to-cart';
	}

	public function get_title() {
		return esc_html__( 'Product Add to Cart', 'crt-manage' );
	}

	public function get_icon() {
		return 'crt-icon eicon-product-add-to-cart';
	}
	...
	public function get_script_depends() {
		return ['wc-add-to-cart', 'wc-add-to-cart-variation', 'wc-single-product', 'crt-product-add-to-cart'];
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			'ajax_add_to_cart',
			[
				'label' => esc_html__( 'Enable AJAX Add To Cart', 'crt-manage' ),
		...
		$this->add_control(
			...
			[
				...
				'prefix_class' => 'crt-add-to-cart-layout-',
				'selectors_dictionary' => [
					'row' => 'display: flex; align-items: center;',
					'column' => 'display: flex; flex-direction: column;',
				],
                'selectors' => [
                    '{{WRAPPER}} .crt-product-add-to-cart .cart' => '{{VALUE}};'
                ],
				'separator' => 'before'
			]
		);
        ...
        $this->add_responsive_control(
            ...
            [
                'label'     => esc_html__('Text Align', 'crt-manage'),
                'type'      => Controls_Manager::CHOOSE,
                'options'   => [
                    'left'   => [
                ...
                'default'   => 'left',
                'selectors' => [
                    '{{WRAPPER}} .crt-product-add-to-cart .cart' => 'text-align: {{VALUE}}',
        ...
        $this->add_responsive_control(
            ...
            [
                'label'     => esc_html__('Button Horizontal Align', 'crt-manage'),
                'type'      => Controls_Manager::CHOOSE,
                'options'   => [
                    'left'   => [
                        'title' => esc_html__('Left', 'crt-manage'),
                ...
                'prefix_class' => 'crt-product-adc-align-',
                'default'   => 'left',
				'condition' => [
        ...
        $this->add_responsive_control(
            ...
            [
                'label'     => esc_html__('Button Vertical Align', 'crt-manage'),
                'type'      => Controls_Manager::CHOOSE,
                'options'   => [
                    'end'   => [
                ...
                'default'   => 'left',
                'selectors' => [
                    '{{WRAPPER}} .crt-product-add-to-cart .cart button' => 'align-self: {{VALUE}}',
		...
		$this->add_control( 
			...
			[
				'label' => esc_html__( 'Choose An Option Display', 'crt-manage' ),
				'type' => Controls_Manager::SELECT,
				'label_block' => true,
				'options' => [
					'row' => esc_html__( 'Inline', 'crt-manage' ),
					'column' =>  esc_html__( 'Separate', 'crt-manage' )
				],
				'prefix_class' => 'crt-variations-layout-',
				'selectors_dictionary' => [
					'row' => '',
					'column' => 'display: flex; flex-direction: column;',
				],
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Button Display', 'crt-manage' ),
				'type' => Controls_Manager::SELECT,
				'options' => [
					'row' => esc_html__( 'Inline', 'crt-manage' ),
					'column' => esc_html__( 'Separate', 'crt-manage' ),
				],
				'prefix_class' => 'crt-buttons-layout-',
				'selectors_dictionary' => [
					'row' => 'flex-direction: row;',
					'column' => 'flex-direction: column;',
				],
                'selectors' => [
                    '{{WRAPPER}}.elementor-widget-crt-product-add-to-cart .woocommerce-variation-add-to-cart' => '{{VALUE}};',
                    '{{WRAPPER}} .crt-product-add-to-cart .crt-simple-qty-wrap' => 'display: flex; {{VALUE}};'
                ],
				'default' => 'row',
			]
		);
        ...
        $this->add_control(
            ...
            [
                'label'   => esc_html__('Quantity Input Style', 'crt-manage'),
                'type'    => Controls_Manager::SELECT,
                'default' => 'after',
				'prefix_class' => 'crt-product-qty-align-',
                'options' => [
                    'default' => esc_html__('Default (Browser)', 'crt-manage'),
                    'before' => esc_html__('Triggers Left', 'crt-manage'),
                    'after' => esc_html__('Triggers Right', 'crt-manage'),
                    'both' => esc_html__('Triggers Left-Right', 'crt-manage'),
                ],
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Add to Cart Quantity', 'crt-manage' ),
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					...
					'{{WRAPPER}} .crt-product-add-to-cart .crt-quantity-wrapper i' => 'color: {{VALUE}}',
					'{{WRAPPER}} .crt-product-add-to-cart .crt-quantity-wrapper svg' => 'fill: {{VALUE}}',
					'{{WRAPPER}} .crt-product-add-to-cart .quantity .qty' => 'color: {{VALUE}}',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					...
					'{{WRAPPER}} .crt-product-add-to-cart .crt-quantity-wrapper i' => 'background-color: {{VALUE}}',
					'{{WRAPPER}} .crt-product-add-to-cart .quantity .qty' => 'background-color: {{VALUE}}',
				]
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					...
					'{{WRAPPER}} .crt-product-add-to-cart .crt-quantity-wrapper i' => 'border-color: {{VALUE}}',
					'{{WRAPPER}} .crt-product-add-to-cart .quantity .qty' => 'border-color: {{VALUE}}',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					...
					'{{WRAPPER}} .crt-product-add-to-cart .crt-quantity-wrapper i' => 'transition-duration: {{VALUE}}s',
					'{{WRAPPER}} .crt-product-add-to-cart .quantity .qty' => 'transition-duration: {{VALUE}}s',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					...
					'{{WRAPPER}} .crt-product-add-to-cart .crt-quantity-wrapper i:hover' => 'color: {{VALUE}}',
					'{{WRAPPER}} .crt-product-add-to-cart .quantity .qty:hover' => 'color: {{VALUE}}',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					...
					'{{WRAPPER}} .crt-product-add-to-cart .crt-quantity-wrapper i:hover' => 'background-color: {{VALUE}}',
					'{{WRAPPER}} .crt-product-add-to-cart .quantity .qty:hover' => 'background-color: {{VALUE}}',
				]
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .crt-product-add-to-cart .quantity .qty' => 'font-size: {{SIZE}}{{UNIT}};',
				]
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .crt-product-add-to-cart .quantity .qty' => 'height: {{SIZE}}{{UNIT}};',
					'{{WRAPPER}} .crt-product-add-to-cart .crt-quantity-wrapper i' => 'height: calc({{SIZE}}{{UNIT}}/2);',
					'{{WRAPPER}}.crt-product-qty-align-both .crt-product-add-to-cart .crt-quantity-wrapper i' => 'height: {{SIZE}}{{UNIT}};',
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .crt-product-add-to-cart .quantity .qty' => 'width: {{SIZE}}{{UNIT}};'
				]
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}}.crt-buttons-layout-row .crt-product-add-to-cart .crt-simple-qty-wrap .crt-quantity-wrapper' => 'margin-right: {{SIZE}}{{UNIT}};',
					'{{WRAPPER}}.crt-buttons-layout-column .crt-product-add-to-cart .crt-simple-qty-wrap .crt-quantity-wrapper' => 'margin-bottom: {{SIZE}}{{UNIT}};',
					'{{WRAPPER}}.crt-buttons-layout-row .crt-product-add-to-cart .variations_button .crt-quantity-wrapper' => 'margin-right: {{SIZE}}{{UNIT}};',
					'{{WRAPPER}}.crt-buttons-layout-column .crt-product-add-to-cart .variations_button .crt-quantity-wrapper' => 'margin-bottom: {{SIZE}}{{UNIT}};'
				]
			]
		);
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Trigger Icons', 'crt-manage' ),
				'type' => Controls_Manager::HEADING,
				'separator' => 'before',
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .crt-product-add-to-cart .crt-quantity-wrapper i' => 'font-size: {{SIZE}}{{UNIT}};',
					'{{WRAPPER}} .crt-product-add-to-cart .crt-quantity-wrapper svg' => 'width: {{SIZE}}{{UNIT}}; height: {{SIZE}}{{UNIT}};',
				]
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .crt-product-add-to-cart .crt-quantity-wrapper i' => 'width: {{SIZE}}{{UNIT}};',
				]
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default' => 'solid',
				'selectors' => [
					'{{WRAPPER}} .crt-product-add-to-cart .crt-quantity-wrapper i' => 'border-style: {{VALUE}};',
					'{{WRAPPER}} .crt-product-add-to-cart .quantity .qty' => 'border-style: {{VALUE}};',
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .crt-product-add-to-cart .crt-quantity-wrapper i' => 'border-width: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
					'{{WRAPPER}} .crt-product-add-to-cart .quantity .qty' => 'border-width: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}}.crt-product-qty-align-before .qty' => 'border-radius: 0 {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} 0;',
					'{{WRAPPER}}.crt-product-qty-align-before .crt-quantity-wrapper i:first-child' => 'border-radius: {{TOP}}{{UNIT}} 0 0 0;',
					'{{WRAPPER}}.crt-product-qty-align-before .crt-quantity-wrapper i:last-child' => 'border-radius: 0 0 0 {{LEFT}}{{UNIT}};',
					'{{WRAPPER}}.crt-product-qty-align-after .qty' => 'border-radius: {{TOP}}{{UNIT}} 0 0 {{Left}}{{UNIT}};',
					'{{WRAPPER}}.crt-product-qty-align-after .crt-quantity-wrapper i:first-child' => 'border-radius: 0 {{RIGHT}}{{UNIT}} 0 0;',
					'{{WRAPPER}}.crt-product-qty-align-after .crt-quantity-wrapper i:last-child' => 'border-radius: 0 0 {{BOTTOM}}{{UNIT}} 0;',
					'{{WRAPPER}}.crt-product-qty-align-both .qty' => 'border-radius: 0;',
					'{{WRAPPER}}.crt-product-qty-align-both .crt-quantity-wrapper i:first-child' => 'border-radius: {{TOP}}{{UNIT}} 0 0 {{Left}}{{UNIT}};',
					'{{WRAPPER}}.crt-product-qty-align-both .crt-quantity-wrapper i:last-child' => 'border-radius: 0 {{Right}}{{UNIT}} {{BOTTOM}}{{UNIT}} 0;',
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Add to Cart Button', 'crt-manage' ),
				'tab' => Controls_Manager::TAB_STYLE,
				'show_label' => false,
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default' => '#FFFFFF',
				'selectors' => [
					'{{WRAPPER}} .crt-product-add-to-cart .single_add_to_cart_button' => 'color: {{VALUE}}',
					'{{WRAPPER}} .crt-product-add-to-cart a.added_to_cart' => 'color: {{VALUE}}',
		...
		$this->add_control(
			...
			[
				...
				'default' => '#e55b5b',
				'selectors' => [
					'{{WRAPPER}} .crt-product-add-to-cart .single_add_to_cart_button' => 'background-color: {{VALUE}}',
					'{{WRAPPER}} .crt-product-add-to-cart a.added_to_cart' => 'background-color: {{VALUE}}',
		...
		$this->add_control(
			...
			[
				...
				'default' => '#E8E8E8',
				'selectors' => [
					'{{WRAPPER}} .crt-product-add-to-cart .single_add_to_cart_button' => 'border-color: {{VALUE}}',
					'{{WRAPPER}} .crt-product-add-to-cart  a.added_to_cart' => 'border-color: {{VALUE}}',
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .crt-product-add-to-cart .single_add_to_cart_button, {{WRAPPER}} .crt-product-add-to-cart  a.added_to_cart,',
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'step' => 0.1,
				'selectors' => [
					'{{WRAPPER}} .crt-product-add-to-cart .single_add_to_cart_button' => 'transition-duration: {{VALUE}}s',
					'{{WRAPPER}} .crt-product-add-to-cart  a.added_to_cart' => 'transition-duration: {{VALUE}}s',
		...
		$this->add_control(
			...
			[
				...
				'default' => '#FFFFFF',
				'selectors' => [
					'{{WRAPPER}} .crt-product-add-to-cart .single_add_to_cart_button:hover' => 'color: {{VALUE}}',
					'{{WRAPPER}} .crt-product-add-to-cart  a.added_to_cart:hover' => 'color: {{VALUE}}',
		...
		$this->add_control(
			...
			[
				...
				'default' => '#2D26ED',
				'selectors' => [
					'{{WRAPPER}} .crt-product-add-to-cart .single_add_to_cart_button:hover' => 'background-color: {{VALUE}}',
					'{{WRAPPER}} .crt-product-add-to-cart  a.added_to_cart:hover' => 'background-color: {{VALUE}}',
		...
		$this->add_control(
			...
			[
				...
				'default' => '#E8E8E8',
				'selectors' => [
					'{{WRAPPER}} .crt-product-add-to-cart .single_add_to_cart_button:hover' => 'border-color: {{VALUE}}',
					'{{WRAPPER}} .crt-product-add-to-cart  a.added_to_cart:hover' => 'border-color: {{VALUE}}',
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .crt-product-add-to-cart .single_add_to_cart_button:hover, {{WRAPPER}} .crt-product-add-to-cart  a.added_to_cart:hover',
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}}  .crt-product-add-to-cart .single_add_to_cart_button' => 'width: {{SIZE}}{{UNIT}};',
					'{{WRAPPER}} .crt-product-add-to-cart  a.added_to_cart' => 'width: {{SIZE}}{{UNIT}};'
				],
				'separator' => 'before',
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}}  .crt-product-add-to-cart .single_add_to_cart_button' => 'height: {{SIZE}}{{UNIT}};',
					'{{WRAPPER}} .crt-product-add-to-cart  a.added_to_cart' => 'height: {{SIZE}}{{UNIT}};'
				]
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}}.crt-add-to-cart-layout-row table' => 'margin-right: {{SIZE}}{{UNIT}};',
					'{{WRAPPER}}.crt-add-to-cart-layout-column table' => 'margin-bottom: {{SIZE}}{{UNIT}};',
					'{{WRAPPER}}.crt-add-to-cart-layout-row .crt-product-add-to-cart form.cart .woocommerce-variation-add-to-cart' => 'margin-left: {{SIZE}}{{UNIT}};',
					'{{WRAPPER}}.crt-add-to-cart-layout-column .crt-product-add-to-cart form.cart .woocommerce-variation-add-to-cart' => 'margin-top: {{SIZE}}{{UNIT}};',
				],
				'separator' => 'before'
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .crt-product-add-to-cart .single_add_to_cart_button' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
					'{{WRAPPER}} .crt-product-add-to-cart  a.added_to_cart' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};'
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default' => 'none',
				'selectors' => [
					'{{WRAPPER}} .crt-product-add-to-cart .single_add_to_cart_button' => 'border-style: {{VALUE}};',
					'{{WRAPPER}} .crt-product-add-to-cart  a.added_to_cart' => 'border-style: {{VALUE}};'
				],
				'separator' => 'before'
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .crt-product-add-to-cart .single_add_to_cart_button' => 'border-width: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
					'{{WRAPPER}} .crt-product-add-to-cart  a.added_to_cart' => 'border-width: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};'
				],
				'condition' => [
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .crt-product-add-to-cart .single_add_to_cart_button' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
					'{{WRAPPER}} .crt-product-add-to-cart  a.added_to_cart' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Grouped Product', 'crt-manage' ),
				'tab' => Controls_Manager::TAB_STYLE,
				'show_label' => false,
			]
		);
		...
		$this->add_control(
			'add_to_cart_group',
			[
				'label'     => esc_html__('Variable Product', 'crt-manage'),
				'type'      => Controls_Manager::HEADING,
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .crt-product-add-to-cart form.cart .group_table td' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
				'separator' => 'before'
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}}.crt-variations-layout-row .variations tr th' => 'width: {{SIZE}}%;',
					'{{WRAPPER}}.crt-variations-layout-column .variations tr th' => 'width: {{SIZE}}%;',
				],
				'separator' => 'before',
			]
		);
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Variations Select', 'crt-manage' ),
				'tab' => Controls_Manager::TAB_STYLE,
				'show_label' => false,
			]
		);
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Variations Item Info', 'crt-manage' ),
				'tab' => Controls_Manager::TAB_STYLE,
				'show_label' => false,
			]
		);
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Alignment', 'crt-manage' ),
				'description' => esc_html__('For Variable Products Only', 'crt-manage'),
				'type' => Controls_Manager::CHOOSE,
				'options' => [
					'left'    => [
						'title' => esc_html__( 'Left', 'crt-manage' ),
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Availability', 'crt-manage' ),
				'type' => Controls_Manager::HEADING,
				'separator' => 'before',
			]
		);
		...
		$this->add_control(
			...
			[
				'label'  => esc_html__( 'In Stock Color', 'crt-manage' ),
				'type' => Controls_Manager::COLOR,
				'default' => '#e55b5b',
				'selectors' => [
		...
		$this->start_controls_section(
			'section_style_reset',
			[
				'label' => esc_html__( 'Reset Options Button', 'crt-manage' ),
				'tab' => Controls_Manager::TAB_STYLE,
				'show_label' => false,
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default' => '#CECECE',
				'selectors' => [
					'{{WRAPPER}} .crt-product-add-to-cart .reset_variations' => 'color: {{VALUE}};',
				]
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default' => '#FFFFFF',
				'selectors' => [
					'{{WRAPPER}} .crt-product-add-to-cart .reset_variations' => 'background-color: {{VALUE}};',
				]
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default' => '#E8E8E8',
				'selectors' => [
					'{{WRAPPER}} .crt-product-add-to-cart .reset_variations' => 'border-color: {{VALUE}};',
				]
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .crt-product-add-to-cart .reset_variations',
				'fields_options' => [
					'typography' => [
						'default' => 'custom',
					],
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .crt-product-add-to-cart .reset_variations' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
				'separator' => 'before',
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .crt-product-add-to-cart .reset_variations' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				]
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default' => 'none',
				'selectors' => [
					'{{WRAPPER}} .crt-product-add-to-cart .reset_variations' => 'border-style: {{VALUE}};',
				],
				'separator' => 'before',
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .crt-product-add-to-cart .reset_variations' => 'border-width: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
				'condition' => [
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .crt-product-add-to-cart .reset_variations' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
	...
	function custom_wc_add_to_cart_message( $message, $product_id ) { 
		$message = sprintf(esc_html__('%s has been added to your cart. Thank you for shopping!','crt-manage'), get_the_title( $product_id ) ); 
		return $message; 
	}
	...
	function before_add_to_cart_quantity() {
		...
		if ($product->is_type('simple')) {
			echo '<div class="crt-simple-qty-wrap">';
		}
		echo '<div class="crt-quantity-wrapper">';

		if($btn_arg['position'] === 'before') {
			echo '<div class="crt-add-to-cart-icons-wrap"><i class="fas fa-plus"></i><i class="fas fa-minus"></i></i></div>';
		}
