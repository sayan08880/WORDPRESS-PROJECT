...
class CRT_Page_Checkout extends Widget_Base {
	
	public function get_name() {
		return 'crt-page-checkout';
	}

	public function get_title() {
		return esc_html__( 'Checkout', 'crt-manage' );
	}

	public function get_icon() {
		return 'crt-icon eicon-checkout';
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'default' => 'horizontal',
				'prefix_class' => 'crt-checkout-',
				'options' => [
					'vertical' => esc_html__( 'One Column', 'crt-manage' ),
					'horizontal' => esc_html__( 'Two Columns', 'crt-manage' ),
				],
				'label_block' => false,
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}}.crt-checkout-horizontal .crt-checkout-order-review-table' => 'width: {{SIZE}}{{UNIT}};',
					// '{{WRAPPER}}.crt-checkout-horizontal #customer_details' => 'width: {{SIZE}}{{UNIT}};',
					// '{{WRAPPER}}.crt-checkout-horizontal .crt-checkout-order-review-table' => 'width: calc(100% - {{SIZE}}{{UNIT}});',
				],
				'condition' => [
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					...
					'{{WRAPPER}} .crt-checkout-order-review-table-inner' => 'background-color: {{VALUE}}',
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					...
					'{{WRAPPER}} .crt-checkout-order-review-table-inner' => 'border-color: {{VALUE}}',
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					...
					'{{WRAPPER}} .crt-checkout-order-review-table-inner' => 'border-style: {{VALUE}};',
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					...
					'{{WRAPPER}} .crt-checkout-order-review-table-inner' => 'border-width: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					...
					'{{WRAPPER}} .crt-checkout-order-review-table-inner' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					...
					'{{WRAPPER}} .crt-checkout-order-review-table-inner' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}}.crt-checkout-horizontal .woocommerce-checkout .col2-set' => 'margin-right: {{SIZE}}{{UNIT}};',
					'[data-elementor-device-mode="mobile"] {{WRAPPER}}.crt-checkout-horizontal .woocommerce-checkout .col2-set' => 'margin-bottom: {{SIZE}}{{UNIT}};',
					'{{WRAPPER}}.crt-checkout-horizontal .col-1' => 'margin-bottom: {{SIZE}}{{UNIT}};',
					'{{WRAPPER}}.crt-checkout-horizontal .crt-checkout-order-review-table-inner' => 'margin-bottom: {{SIZE}}{{UNIT}};',
					'{{WRAPPER}}.crt-checkout-vertical .col-1' => 'margin-bottom: {{SIZE}}{{UNIT}};',
					'{{WRAPPER}}.crt-checkout-vertical .col-2' => 'margin-bottom: {{SIZE}}{{UNIT}};',
					'{{WRAPPER}}.crt-checkout-vertical .crt-checkout-order-review-table-inner' => 'margin-bottom: {{SIZE}}{{UNIT}};',
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Titles', 'crt-manage' ),
				'tab' => Controls_Manager::TAB_STYLE,
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				'type' => Controls_Manager::SLIDER,
				'label' => esc_html__( 'Textarea Height', 'crt-manage' ),
				'size_units' => [ 'px' ],
				'range' => [
					'px' => [
						'min' => 0,
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Place Order', 'crt-manage' ),
				'tab' => Controls_Manager::TAB_STYLE,
				'show_label' => false,
			]
		);
		...
		$this->add_control(
			...
			[
				'type' => Controls_Manager::HEADING,
				'label' => esc_html__( 'Order Received', 'crt-manage' ),
				'separator' => 'before'
			]
		);
		...
		$this->add_control(
			...
			[
				'type' => Controls_Manager::HEADING,
				'label' => esc_html__( 'Order Overview Typography', 'crt-manage' ),
				'separator' => 'before'
			]
		);
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Coupon & Place Order Button', 'crt-manage' ),
				'tab' => Controls_Manager::TAB_STYLE,
				'show_label' => false,
			]
		);
	...
	public function woocommerce_checkout_before_order_review_heading() {
        echo '<div class="crt-checkout-order-review-table">';
        echo '<div class="crt-checkout-order-review-table-inner">';
	}
	...
	public function woocommerce_checkout_order_review() {
		echo '</div>';
		echo '</div>';
		echo '<div class="crt-checkout-order-review">';
	}
