(function($) {
    ...
    $(window).on( 'elementor/frontend/init', function() {
        elementorFrontend.hooks.addAction('frontend/element_ready/crt-woo-category-grid-pro.default',function($scope) {
            ...
            if ( typeof settings !== typeof undefined && settings !== false ) {
                ...
                if ( 'load-more' === settings.pagination_type || 'infinite-scroll' === settings.pagination_type ) {
                    if ( $scope.find( '.crt-grid-pagination' ).length && ! CrtElements.editorCheck() ) {
            ...
            // Init Lightbox
            if ( !$scope.hasClass('elementor-widget-crt-woo-category-grid-pro') && !$scope.hasClass('elementor-widget-crt-category-grid-pro') ) {
                CrtElements.lightboxPopup( settings, $scope, iGrid );
            }
