...
/**
 * Title: My Blog
 * Slug: pro-portfolio/my-blog
 * Categories: pro-portfolio
 */
?>
<!-- wp:group {"tagName":"section","metadata":{"name":"My Blog Section"},"align":"full","className":"my-blog","style":{"spacing":{"padding":{"top":"5rem","right":"30px","left":"30px","bottom":"0"}}},"layout":{"type":"constrained"}} -->
<section class="wp-block-group alignfull my-blog" style="padding-top:5rem;padding-right:30px;padding-bottom:0;padding-left:30px"><!-- wp:group {"align":"wide","style":{"spacing":{"padding":{"bottom":"5rem"}},"border":{"bottom":{"color":"var:preset|color|border","width":"1px"},"top":[],"right":[],"left":[]}},"layout":{"type":"constrained"}} -->
...
<p class="has-text-align-center has-primary-color has-text-color has-link-color" style="letter-spacing:5px"><?php echo esc_html__( 'Visit my blog and keep your feedback', 'pro-portfolio' ); ?></p>
<!-- /wp:paragraph -->
...
<h2 class="wp-block-heading has-text-align-center has-foreground-color has-text-color has-link-color has-large-font-size"><?php echo esc_html__( 'My Blog', 'pro-portfolio' ); ?></h2>
<!-- /wp:heading --></div>
<!-- /wp:group -->

<!-- wp:group {"align":"wide","layout":{"inherit":true,"type":"constrained"}} -->
<div class="wp-block-group alignwide"><!-- wp:query {"queryId":1,"query":{"perPage":3,"pages":"1","offset":"0","postType":"post","order":"desc","orderBy":"title","author":"","search":"","exclude":[],"sticky":"","inherit":false,"taxQuery":null,"parents":[],"format":[]},"tagName":"main","align":"wide","layout":{"type":"default"}} -->
...
<div class="wp-block-group alignwide" style="margin-top:20px;padding-top:0px;padding-right:0px;padding-bottom:0px;padding-left:0px"><!-- wp:group {"layout":{"type":"flex","flexWrap":"nowrap","justifyContent":"space-between"}} -->
<div class="wp-block-group"><!-- wp:post-date {"textAlign":"center","isLink":true,"metadata":{"bindings":{"datetime":{"source":"core/post-data","args":{"field":"date"}}}},"style":{"typography":{"textDecoration":"none"},"elements":{"link":{"color":{"text":"var:preset|color|boulder"}}}},"textColor":"boulder","fontSize":"tiny"} /-->

<!-- wp:post-terms {"term":"category","style":{"elements":{"link":{"color":{"text":"var:preset|color|primary"}}},"typography":{"textDecoration":"none"}},"textColor":"primary","fontSize":"extra-small"} /--></div>
<!-- /wp:group -->

<!-- wp:post-title {"level":3,"isLink":true,"align":"wide","style":{"typography":{"fontStyle":"normal","fontWeight":"600"}},"textColor":"foreground"} /--></div>
<!-- /wp:group --></div>
<!-- /wp:group -->
